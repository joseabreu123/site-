<?php 
	...
	$espaço = " ";
	$sql = "INSERT INTO classics (name,recipe,image,username) VALUES ('$namecocktail','$reccocktail','images/$file_name','$nome' '$espaço' '$apelido')";
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label for="nome">Nome do cocktail:</label>
		<input maxlength="100" type="text" class="form-control" id="namecocktail" name="namecocktail" required>
	</div>
	<div class="form-group">
    <label for="receita">Receita do cocktail:</label>
    <textarea maxlength="700" style="resize: vertical;" class="form-control" id="reccocktail" name="reccocktail" rows="3" required></textarea>
    </div>
	<div class="form-group">
	<label for="img">Seleciona a imagem:</label>
